...
ls $DEF_FILE_DIR | grep .proto | xargs -I filename ./protoc filename --proto_path=$DEF_FILE_DIR_SERVER --proto_path=$DEF_FILEDEF_FILE_DIR_COMMON_DIR --csharp_out=$DEF_FILE_DIR_SERVER
